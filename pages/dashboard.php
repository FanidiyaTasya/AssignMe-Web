...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="collapse navbar-collapse  w-auto color-blue max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Halaman Buat Kelas</h6>
        </li>
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Halaman buat gabung kelas</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="../pages/arsip.html">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center dropdown">
              <a href="#" class="nav-link text-body font-weight-bold px-0" role="button" id="userDropdown"
          ...
          <div class="modal-body">
            <form method="POST">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="classname" id="classname" placeholder="Enter Class Name"
                  required>
              </div>
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="dropdown float-end">
                <i class="fas text-muted dropdown-toggle" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown"
                  aria-expanded="false"></i>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  <li><a href="#" data-toggle="modal" data-target="#editKelasModal"
                      class="editKelasModalLink dropdown-item text-left text-dark" data-class-id="<?= $row['ClassId'] ?>"
                      data-classname="<?= $row['ClassName'] ?>" data-subject="<?= $row['SubjectName'] ?>"
              ...
              <div>
                <h4><a href="#" class="class-link" data-class-id="<?= $row['ClassId'] ?>">
                    <?= $row['ClassName'] ?>
                  </a></h4>
                <p><a href="#" class="class-link" data-class-id="<?= $row['ClassId'] ?>">
                    <?= $row['SubjectName'] ?>
                  </a></p>
              </div>
    ...
    <div class="fixed-plugin">
      <a class="fixed-plugin-button text-dark position-fixed px-3 py-2" style="right: 0;">
